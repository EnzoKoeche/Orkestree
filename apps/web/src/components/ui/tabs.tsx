...
// Standard shadcn/ui Tabs primitives over @radix-ui/react-tabs. Keeps the
// neutral palette (bg-muted on the rail, bg-card on the active tab) and the
// focus-visible:ring-ring treatment used by every other interactive surface
// in the app — Tabs is "chrome", not "primary action", so no indigo here.
