...
- [ ] Selects do service são role-aware (INTERNAL vs CLIENT) onde há campo sensível.
- [ ] Campo sensível novo está no `SENSITIVE_FIELD_REGISTRY`.
- [ ] PDF para CLIENTE usa **apenas** o select CLIENT.
